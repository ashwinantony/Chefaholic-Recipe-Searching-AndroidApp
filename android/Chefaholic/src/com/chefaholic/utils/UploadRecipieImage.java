...
public class UploadRecipieImage {
	String res = "";
	public String upload(File file, String username, String name, String ingradients, String making,String category) {
		...
		try {
			...
			if (file.exists()) {
				...
				bean.setIngredients(ingradients);
				bean.setCategories(category);
				bean.setMaking(making);
