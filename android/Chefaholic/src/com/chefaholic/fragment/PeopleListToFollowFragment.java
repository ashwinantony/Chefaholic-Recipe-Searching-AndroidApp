...
import com.chefaholic.adapter.FollowersAdapter;
...
public class PeopleListToFollowFragment extends ListFragment {
	...
	private class GetUsersList extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			try {
				...
				builder.append(AppConstants.USERSERVLET);
		...
		protected void onPostExecute(String result) {
			...
			if (result != null) {
				if (!result.equals("")) {
					...
					followersadapter = new FollowersAdapter(context,
