...
import com.chefaholic.utils.UploadRecipieImage;

public class RecipieUploadActivity extends Activity implements OnClickListener {
	...
	public class SendTask extends AsyncTask<String, Void, String> {
		...
		protected String doInBackground(String... params) {
			...
			String res = new UploadRecipieImage().upload(file, PreferenceManager
					.getDefaultSharedPreferences(RecipieUploadActivity.this)
					.getString(AppConstants.USERNAME, ""),params[1],params[2],params[3],params[4]);
			return res;
		}
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ingrediants = getIntent().getExtras().getString("ingredients");
		making = getIntent().getExtras().getString("making");
	...
	public void onClick(View v) {
		...
		if (v.getId() == browseButton.getId()) {
			...
			if (!path.equals("")) {
				new UploadProfilePictureAsyncTask().execute(username, image, name, ingrediants, making,category);
			}
		}
	}
	...
	private void sendvalues(String path2) {
		// TODO Auto-generated method stub
		new SendTask().execute(path2,name, ingrediants, making,category);
	}
