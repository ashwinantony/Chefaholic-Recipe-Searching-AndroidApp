...
import com.chefaholic.activity.ViewUsersRecipieActivity;
...
public class UnFollowAdapter extends ArrayAdapter<FollowersModel> {
	Context context;
	...
	public UnFollowAdapter(Context context, int followersList,
			ArrayList<FollowersModel> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		view.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				String uname = list.get(position).getUsername();
				Intent i = new Intent(context,ViewUsersRecipieActivity.class);
